	...
	<body>
		<div id="title">ACCOUNT</div>
			<div id="background">
				...
				<div id="forms">
					<form action="update_ema.php">
						<input class="inputbox" name=email placeholder="Current Email Address" type=email>
						<input class="inputbox" name=n_email placeholder="New Email Address" type=email>
				...
				{
					echo '<div><f_error>The Email you have entered, does not exist.</f_error></div>';
				}
				
				if ($_GET['password'] == "invalid")
				{
					echo '<div><f_error>The Password you have entered, is not valid.</f_error></div>';
				}
