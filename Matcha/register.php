<html>
    ...
    <body>
        <div id="titlebox">
			...
			</div> <!-- Remember to add page refrences into the images!! -->
			...
			<div class="box">
				<div id=loginHeader>Register</div>
				<form action="create.php">
					<!-- First Name, Last name, Email, Password, Confirm Password, More about yourself, Gender, Preference, Button -->
					<input class="inputbox" style="margin-top: 20px;" type="text" name=first_name placeholder="First Name">
					<input class="inputbox" type="text" name=last_name placeholder="Last Name">
					<input class="inputbox" type=email name=email placeholder="Email Address">
					<input class="inputbox" type="password" name="password" placeholder="Password">
					<input class="inputbox" type=number name="age" placeholder="Enter your Age... 18-60" max="60" min="18">
					<textarea class="inputbox" style="height: 100px" cols="86" rows="20" name="biography" maxlength="500" placeholder="Summarise yourself! Maximum length 500 characters..."></textarea>
					<select class="inputbox" name="gender" placeholder="Select Gender">
